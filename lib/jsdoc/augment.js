...
function getInheritedAdditions(doclets, docs, {documented, memberof}) {
    ...
    for (let i = 0, ii = doclets.length; i < ii; i++) {
        ...
        // Croquet addition: skip lookup on any doclet that has already
        // been marked as undocumented.  Otherwise we were running addition
        // twice for any class that had a class comment and a constructor,
        // which was causing the logic below to assume that inherited
        // properties and methods were always being overridden.
